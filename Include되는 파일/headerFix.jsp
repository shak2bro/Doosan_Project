...
<!-- 
	...
	if(!($.browser.msie)){
		/* origin Source */
		var myScroll;
		function loaded() { myScroll = new iScroll('wrapper', {useTransform: false, onBeforeScrollStart: null}); }
...
<!-- origin : master Javascript // SYSTEM Application -->
	<script type="text/javascript">		
		...
		function loadingBox(option){
			...
			}else if(option == "0" || option == undefined){ //dimmedBox Hide
			...
			if(id != undefined){
				...
				if(idVal == "confirmed"){
					...
					if(url != "undefined" && url != null){
						...
						$('div.end').html('<a href="javscript:return;" class="popClose">确认</a>');
					}
					$('div.end').find('a').css('width', $("div.content").width()+10);
				}
